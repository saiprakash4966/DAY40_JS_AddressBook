...
function selectFunction(select){
    switch(select){
        case "contactDetails":
                 ...
                 */
                contactDetails("Saiprakash","Beemari","Sapthagiri colony","Ramnagar","Telangana","505 001","saiprakashbeemari@gmail.com","91 9676113169");
                contactDetails("Manojkumar","Gadham","JNTU","KPHB","Telangana","505 002","manojkumar@gmail.com","91 9786543210");
                ...
                */
                ...
                contactDetails("Sravan","Reddy","Rangapet","Manakondoor","Telangana","505 004","sravanreddy@gmail.com","91 9989786540");
        ...
        case "editContact":
                ...
                */
                editContact("Saiprakash","city","Sapthagiri colony");
                console.log(addressBook);
                break;
        case "deleteContact":
                /*
        ...
        case "searchByCity_State":
                ...
                */
                searchByCity_State("state","Telangana");
                break;
        case "viewByCityOrState":
                /*
                Calling View By State or City Function
                */
                viewByCityOrState("state","Telangana");
                break;
        case "countContactInCity_State":
                /*
                Calling Count by City And State Function
                */
                countContactInCity_State("state","Telangana");
                countContactInCity_State("city","Karimnagar");
                break;
        case "sortContact":
                /*
